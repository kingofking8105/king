...
<div style="background-color: #fff0e0;color:white;font-weight: bold;border: double 3px blue;padding: 5px;border-radius: 20px;text-align: center;">
    ...
    <p style="font-size:20px; color:green">Satta King Ceo</p>
            ...
            <div class="border row">
                <div class="border column" style="padding: 0 1px 0 1px; border: 1px solid black; background-color:#003300">
                    <div align="center"><span><a href="/">
                        ...
                        <font=color="white">
                        <img src="{{url('images/new.gif')}}" width="20" height="10" alt="Satta king | Sattaking | Satta result | Satta king online | Satta king result | Satta king live" title="Satta king | Sattaking | Satta result | Satta king online | Satta king result | Satta king live">
                        </font>
...
<div style="background-color: WHITE;color:white;font-weight: bold;border: double 3px blue;padding: 5px;border-radius: 20px;text-align: center;">
    <p style=" font-size: 16px; color: BLACK; ">पास होने के बाद में देने होंगे ₹18000 गेम गली और दिसावर का मिलेगा गेम होगा
        नाम सुधीर कुमार
        व्हाट्सएप नंबर 08607268109</p>
    <p style="font-size:20px; color:green">Suresh Chaudhary</p>
    <p style="font-size:22px; color:#000">08607268109</p>
    <a href="whatsapp://send?text=  &amp;phone=+91-8607268109"><button style="height: 40px;width: 200px;background-color: GREEN;color:#FFF;border: double 3px black;border-radius: 20px;"><font size="4px"><b>Whatsapp Here </b></font></button></a>
</div>
</div>
...
<section class="table-main">
    <div style="width:100%; overflow-x: scroll; margin: auto">
        <table width="100%" class="rtable" style="border:1px thin; text-align:center" cellpadding="0" cellspacing="0" border="1" align="center">
            ...
            <td style=" border-color:#000; background-color:#ffff79; color:#FF0000; font-size:12px; font-weight:bold; padding: 0px 2px 0px 2px;">5:30AM</td>
            <td style=" border-color:#000; background-color:#ffff79; color:#FF0000; font-size:12px; font-weight:bold; padding: 0px 2px 0px 2px;">6:30PM</td>
